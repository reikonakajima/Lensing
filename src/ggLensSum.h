...
class ggLensSum {
 ...
 ggLensSum() :
  lenscounts(0), paircounts(0), weights(0.), wsq(0.), DeltaSigma_t(0.), DeltaSigma_s(0.),
    responsivity(0.), variance_t(0.), variance_s(0.), m(0.), invsigmacrit(0.), lum(0.), z(0.),
  ...
  inline void addMBias(double _m) { m += _m; return; }
  ...
  inline double getMBias() const { return m; }
